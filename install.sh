...
echo "45 19 * * * root cd /opt/ && ./gs-afterhours.sh on && ./gs-afterhours.sh reboot" >> /etc/cron.d/gs-afterhours-on
...
echo "30 6 * * * root cd /opt/ && ./gs-afterhours.sh off && ./gs-afterhours.sh reboot" >> /etc/cron.d/gs-afterhours-off
...
echo "45 6 * * * root cd /opt/ && ./gs-afterhours.sh reboot" >> /etc/cron.d/gs-afterhours-reboot
